        ...
        <div className="flex h-40 items-center justify-center border-b bg-muted/20 px-6">
          {university.logo ? (
            <img
              src={university.logo}
              alt={university.name}
              className="max-h-20 max-w-[220px] object-contain transition-transform duration-300 group-hover:scale-105"
            />
          ) : (
        ...
        <div className="space-y-4 p-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="rounded-xl border p-3 text-center">
              ...
              <p className="font-semibold">
                {university._count?.courses ?? university.courses?.length ?? 0}
              </p>
            </div>
            ...
            <div className="rounded-xl border p-3 text-center">
              ...
              <p className="font-semibold">
                {university._count?.scholarships ??
