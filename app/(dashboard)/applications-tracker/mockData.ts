...
export interface LoanDetail {
    ...
    status: 'Pending' | 'Approved' | 'Sanctioned' | 'Rejected' | 'Draft';
...
export interface VisaDetail {
    depositStatus: 'Paid' | 'Pending' | 'Waived' | 'Not Required' | 'Deposit Not Paid';
    ihsPayment: 'Paid' | 'Pending' | 'Not Required';
    interviewStatus: 'Completed' | 'Pending' | 'Waived' | 'Draft';
    casStatus: 'Received' | 'Pending' | 'Not Required';
    visaStatus: 'Approved' | 'Applied' | 'Decision Pending' | 'Draft Pending' | 'Rejected' | 'Draft';
}
...
export interface Student {
    ...
    currentStage: 'Draft' | 'Lead Created' | 'Application Submitted' | 'Offer Received' | 'Deposit Paid' | 'Interview Completed' | 'CAS Received' | 'Visa Applied' | 'Visa Approved';
...
export const initialStudents: Student[] = [
    ...
    },
    {
        ...
        visaDetails: {
            depositStatus: "Deposit Not Paid",
            ihsPayment: "Not Required",
            interviewStatus: "Draft",
            casStatus: "Not Required",
            visaStatus: "Draft"
        },
        remarks: [
